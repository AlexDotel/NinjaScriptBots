...
{
    public class AnchorPriceAdvancedBot : Strategy
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description = "Anchor multi-slot basado en AnchorRelease. Permite hasta 5 pares Anchor/Check independientes para backtesting y optimizacion.";
                Name = "AnchorPriceAdvancedBot";
