...
{
    public class Breakout55WithFilters : Strategy
    {
        // ===== Indicadores =====
        private ATR atr;
        private ADX adx;
        ...
        protected override void OnBarUpdate()
        {
            ...
            // ===== Cálculo de SL/TP basado en ATR =====
            ...
            // ===== Señales de entrada =====
            bool breakLong = AllowLong && Close[0] > prev55High && Close[1] <= prev55High;
            bool breakShort = AllowShort && Close[0] < prev55Low && Close[1] >= prev55Low;
            ...
            // Gestión BE si ya hubiese algo (por seguridad)
            ManageBreakEven();
        }
        ...
        private void ManageBreakEven()
        {
            ...
            if (Position.MarketPosition == MarketPosition.Long)
            {
                ...
                if (Close[0] >= triggerPrice)
                {
                    ...
                    // Ajuste del stop a precio (usamos SetStopLoss por precio)
